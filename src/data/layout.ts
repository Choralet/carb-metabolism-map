 ...
 * The NADH shuttles are drawn tall and narrow with a horizontal membrane (P side above, N side below), so they read on
...
export const edges: Edge[] = [
  ...
  { id: 'e_pdh', from: 'pyr', to: 'accoa', enz: 'pdh', t: 0.84, tags: 'NAD⁺ + CoA → NADH + CO₂', tagPos: 'r', co: ['NADH', 'CO2', 'CoA'] },
  ...
  { id: 'e_ma_out', from: 'ma_nadh', to: 'sh_ma', style: 'plain', via: [[5800, 6540], [5800, 5345], [5420, 5345]], co: ['NADH'] },
  ...
  { id: 'e_g3_out', from: 'g3_qh2', to: 'sh_g3p', style: 'plain', via: [[6560, 6030], [6560, 5345], [5820, 5345]], co: ['FADH2'] },
];

export const regions: Region[] = [
  { id: 'r_gly', plate: 1, part: 'I', title: 'Glycolysis & gluconeogenesis', sub: 'cytosol', x: 5080, y: 60, w: 960, h: 2100 },
  ...
  { id: 'r_ma', plate: 7, part: 'II', title: 'Malate–aspartate shuttle', sub: 'heart, liver, kidney', x: 5080, y: 5430, w: 700, h: 1240 },
  { id: 'r_g3', plate: 8, part: 'II', title: 'Glycerol 3-P shuttle', sub: 'muscle, brain', x: 5820, y: 5430, w: 700, h: 740 },
];
...
export const captions: Caption[] = [
  ...
  { x: 5850, y: 5515, text: 'INTERMEMBRANE SPACE (P side)' },
