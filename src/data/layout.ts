...
export const nodes: MapNode[] = [
  ...
  { id: 'c_gng', label: 'Gluconeogenesis: why & energetics', x: 1330, y: 1440, kind: 'card', card: 'c_gng' },
...
export const edges: Edge[] = [
  ...
  { id: 'e_pc', from: 'pyr', to: 'oaag', enz: 'pc', style: 'gng', t: 0.55, tags: 'ATP + HCO₃⁻ → ADP + Pi', tagPos: 'below', co: ['ATP'] },
  ...
  { id: 'e_feed', from: 'mono', to: 'f6p', enz: 'feedk', via: [[600, 940], [600, 510]], t: 0.1, tags: '→ G6P or F6P', tagPos: 'above', plainTag: true },
...
export const regions: Region[] = [
  { id: 'r_gly', plate: 1, part: 'I', title: 'Glycolysis & gluconeogenesis', sub: 'cytosol', x: 620, y: 20, w: 960, h: 1940 },
  { id: 'r_feed', plate: 2, part: 'I', title: 'Feeder pathways', sub: 'into glycolysis', x: 20, y: 740, w: 560, h: 260 },
  { id: 'r_ferm', plate: 3, part: 'I', title: 'Fermentation', sub: 'no O₂', x: 20, y: 1780, w: 560, h: 380 },
  { id: 'r_ppp', plate: 4, part: 'I', title: 'Pentose phosphate pathway', sub: 'cytosol', x: 1620, y: 170, w: 740, h: 790 },
  { id: 'r_glyc', plate: 5, part: 'I', title: 'Glycogen metabolism', sub: 'liver & muscle', x: 20, y: 20, w: 560, h: 700 },
  { id: 'r_mito', plate: 6, part: 'II', title: 'Mitochondrion', sub: 'matrix & inner membrane', x: 620, y: 2060, w: 1800, h: 1800, right: true },
  { id: 'r_ma', plate: 7, part: 'II', title: 'Malate–aspartate shuttle', sub: 'heart, liver, kidney', x: 620, y: 3910, w: 1100, h: 730 },
  { id: 'r_g3', plate: 8, part: 'II', title: 'Glycerol 3-phosphate shuttle', sub: 'muscle, brain', x: 1740, y: 3910, w: 680, h: 730 },
];

/** Membrane strips inside the shuttle diagrams. */
export const bands: Band[] = [
  { id: 'b_etc', x: 800, y: 3395, w: 1430, h: 110 },
  { id: 'b_ma', x: 1130, y: 4030, w: 80, h: 500 },
  { id: 'b_g3', x: 1770, y: 4460, w: 630, h: 100 },
];

export const captions: Caption[] = [
  { x: 2380, y: 3375, text: 'MATRIX ↑', anchor: 'end' },
  { x: 2380, y: 3560, text: '↓ INTERMEMBRANE SPACE', anchor: 'end' },
...
export const labels: Label[] = [
  { x: 650, y: 430, kind: 'phase', text: 'Preparatory phase', sub: ['steps 1–5 · spends 2 ATP'] },
  { x: 650, y: 1180, kind: 'phase', text: 'Payoff phase', sub: ['steps 6–10 · makes', '4 ATP + 2 NADH'] },
  { x: 1560, y: 2612, kind: 'section', text: 'Citric acid cycle', anchor: 'middle' },
  { x: 790, y: 3250, kind: 'section', text: 'Oxidative phosphorylation', sub: ['inner mitochondrial membrane'] },
];
...
export const jumps: JumpView[] = [
  { id: 'j_gly1', label: 'Glycolysis 1–5', x: 600, y: 0, w: 900, h: 1050, plate: 'r_gly' },
  { id: 'j_gly2', label: 'Glycolysis 6–10', x: 600, y: 840, w: 900, h: 1160, plate: 'r_gly' },
  { id: 'j_glyc', label: 'Glycogen & feeders', x: 0, y: 0, w: 1300, h: 1040, plate: 'r_glyc' },
  { id: 'j_ppp', label: 'Pentose phosphate', x: 1080, y: 150, w: 1320, h: 840, plate: 'r_ppp' },
  { id: 'j_gng', label: 'Gluconeogenesis', x: 600, y: 0, w: 1320, h: 1980, plate: 'r_gly' },
  { id: 'j_ferm', label: 'Fermentation', x: 0, y: 1740, w: 1300, h: 460, plate: 'r_ferm' },
  { id: 'j_tca', label: 'Citric acid cycle', x: 620, y: 2080, w: 1800, h: 1180, plate: 'r_mito' },
  { id: 'j_oxp', label: 'Oxidative phosphorylation', x: 700, y: 3200, w: 1780, h: 680, plate: 'r_mito' },
  { id: 'j_shuttle', label: 'NADH shuttles', x: 600, y: 3820, w: 1840, h: 850, plate: 'r_ma' },
];

export const desktopScene: Scene = { canvas: CANVAS, nodes, edges, regions, bands, captions, labels, jumps, decor };
...
const phoneRegions: Record<string, Partial<Region>> = {
  r_ma: { x: 620, y: 3910, w: 700, h: 1240 },
  r_g3: { x: 620, y: 5190, w: 700, h: 740 },
};
...
export const phoneScene: Scene = {
  ...
  regions: regions.map((r) => ({ ...r, ...phoneRegions[r.id] })),
  bands: [
    bands[0],
  ...
  jumps: [
    ...
    { id: 'j_ma', label: 'Malate–aspartate', x: 500, y: 3880, w: 830, h: 1300, plate: 'r_ma' },
    { id: 'j_g3', label: 'Glycerol 3-P shuttle', x: 500, y: 5170, w: 830, h: 1360, plate: 'r_g3' },
  ],
};
